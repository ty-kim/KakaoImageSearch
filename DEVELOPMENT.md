...
- **유닛 테스트**: Swift Testing Framework, 173개 케이스, Domain + ViewModel + BookmarkCoordinator + CachedAsyncImageViewModel + DTO + SearchFlowController + SearchPrefetchCoordinator + SearchResultsStore 검증 중심 (`Unit/`)
