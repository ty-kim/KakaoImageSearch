...
- **유닛 테스트**: Swift Testing Framework, 86개 케이스, Domain + ViewModel + BookmarkStore 중심 검증
- **통합 테스트**: Swift Testing Framework, 27개 케이스, NetworkService / BookmarkStorage / ImageDownloader I/O 검증
