...
- **유닛 테스트**: Swift Testing Framework, 167개 케이스, Domain + ViewModel + BookmarkStore + CachedAsyncImageViewModel + DTO + SearchFlowController + SearchPrefetchCoordinator + SearchResultsStore 검증 중심 (`Unit/`)
