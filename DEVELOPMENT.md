...
- **유닛 테스트**: Swift Testing Framework, 94개 케이스, Domain + ViewModel + BookmarkStore 중심 검증
- **통합 테스트**: Swift Testing Framework, 32개 케이스, NetworkService / BookmarkStorage / ImageDownloader / ImageCache I/O 검증
