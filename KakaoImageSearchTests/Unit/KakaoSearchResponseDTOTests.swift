...
struct KakaoSearchResponseDTOTests {
    ...
    // MARK: - SSRF 방어 (사설 IP / loopback 차단)

    @Test("localhost imageUrl은 toImageItem이 nil을 반환한다")
    func toImageItem_localhost_returnsNil() throws {
        let json = """
        {
            "meta": { "total_count": 1, "pageable_count": 1, "is_end": false },
            "documents": [{ "image_url": "https://localhost/image.jpg" }]
        }
        """.data(using: .utf8)!
    ...
    @Test("127.0.0.1 imageUrl은 toImageItem이 nil을 반환한다")
    func toImageItem_loopback_returnsNil() throws {
        let json = """
        {
            "meta": { "total_count": 1, "pageable_count": 1, "is_end": false },
            "documents": [{ "image_url": "https://127.0.0.1/image.jpg" }]
        }
        """.data(using: .utf8)!
    ...
    @Test("192.168.x.x imageUrl은 toImageItem이 nil을 반환한다")
    func toImageItem_privateClassC_returnsNil() throws {
        let json = """
        {
            "meta": { "total_count": 1, "pageable_count": 1, "is_end": false },
            "documents": [{ "image_url": "https://192.168.1.1/image.jpg" }]
        }
        """.data(using: .utf8)!
    ...
    @Test("10.x.x.x imageUrl은 toImageItem이 nil을 반환한다")
    func toImageItem_privateClassA_returnsNil() throws {
        let json = """
        {
            "meta": { "total_count": 1, "pageable_count": 1, "is_end": false },
            "documents": [{ "image_url": "https://10.0.0.1/image.jpg" }]
        }
        """.data(using: .utf8)!
    ...
    @Test("172.16.x.x imageUrl은 toImageItem이 nil을 반환한다")
    func toImageItem_privateClassB_returnsNil() throws {
        let json = """
        {
            "meta": { "total_count": 1, "pageable_count": 1, "is_end": false },
            "documents": [{ "image_url": "https://172.16.0.1/image.jpg" }]
        }
        """.data(using: .utf8)!
    ...
    @Test("사설 IP thumbnailUrl은 nil로 처리된다")
    func toImageItem_privateThumbnail_returnsNilThumbnail() throws {
        let json = """
        {
            "meta": { "total_count": 1, "pageable_count": 1, "is_end": false },
            "documents": [{
                "image_url": "https://example.com/image.jpg",
                "thumbnail_url": "https://192.168.0.1/thumb.jpg"
            }]
        }
        """.data(using: .utf8)!
