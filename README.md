...
Swift Testing Framework 기반 112개 테스트 케이스를 작성했고, 로컬 기준으로 모두 통과했습니다.
...
| `SearchViewModelTests` | 31 | 검색 성공/실패, 취소/race condition 처리, 페이지네이션, API 페이지 제한 vs 결과 소진 구분, 재시도, 오프라인 감지, 북마크 토글/Toast, 연속 토글 dedup, loadMore/prefetch Task 취소 |
