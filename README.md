...
Swift Testing Framework 기반 167개 테스트 케이스를 작성했고, CI 및 로컬 기준으로 모두 통과했습니다.
...
| `SearchFlowControllerTests` | 20 | 검색 흐름 상태, stale response 방지, 페이지네이션 상태 판단, 오프라인 처리, reset |
| `SearchBookmarkHandlerTests` | 4 | 토글 성공/실패, inFlight 관리 |
